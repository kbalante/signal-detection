...
/**
 * Yearly Resolution Report - signal_detection_report_by_year table
 */
@Entity
public class SignalDetectionReportByYear implements SignalDetectionReport {
	...
	protected SignalDetectionReportByYear() {
	}

	public SignalDetectionReportByYear(String assetUN, int numSignals, Date date) {
	...
	public String toString() {
		return "SignalDetectionReportByYear{" +
				"id=" + id +
				", assetUN='" + assetUN + '\'' +
